...
const BlogView = () => {
  ...
  const fetchBlog = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`https://chyrpmodern-production.up.railway.app/blog/${id}`, {
  ...
  const fetchComments = async () => {
    try {
      const res = await axios.get(`https://chyrpmodern-production.up.railway.app/blog/${id}/comments`, {
        withCredentials: true
      });
  ...
  const handleLike = async () => {
    try {
      const res = await axios.post(`https://chyrpmodern-production.up.railway.app/blog/${id}/like`, {}, {
        withCredentials: true,
        headers: {
  ...
  const handleAddComment = async (e) => {
    ...
    try {
      const res = await axios.post(`https://chyrpmodern-production.up.railway.app/blog/${id}/comment`, {
        content: newComment
      }, {
        withCredentials: true,
        headers: {
